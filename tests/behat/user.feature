...
Feature: View the user page for the bbboverview report
  In order to ensure the user page for the bbboverview report works as expected
  As a student
  I need to log in as a student and view the user page for the bbboverview report
  ...
  Scenario: View the user page when only the legacy log reader is enabled
    ...
    When I follow "bbboverview report"
